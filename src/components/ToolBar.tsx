...
import { Plus, Trash2, Settings, Download, Upload, Save, RotateCcw, RotateCw, Moon, Sun, Copy, ClipboardPaste } from 'lucide-react';
    ...
    <div className="flex justify-between items-center mb-8">
      ...
      <div className="flex gap-4">
        ...
        <button
          ...
          title={isDeleteDisabled ? "No panel selected" : "Delete selected panel(s)"}
        >
          <Trash2 size={20} />
        </button>
